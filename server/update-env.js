...
console.log('✅ .env file updated with correct MongoDB URI');
console.log('📍 New MongoDB URI: mongodb+srv://ashishstationery8085_db_user:Ashish%238085@cluster0.r2xqgoj.mongodb.net/?appName=Cluster0');

  ...
  return (
    <div className="mx-auto max-w-xl px-6 py-16 lg:px-8">
      <div className="rounded-3xl bg-white p-10 shadow-sm">
        <h1 className="text-3xl font-semibold text-slate-900">Sign in to PINAKK</h1>
        <p className="mt-3 text-slate-600">Use your email or mobile OTP to access orders, wallet, and wishlist.</p>
